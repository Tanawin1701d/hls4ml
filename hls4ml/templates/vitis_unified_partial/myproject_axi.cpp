...
void enqueue_atom2layer(hls::stream<dma_data_packet> &src_dma_stream, hls::stream<INPUT_LAYER_ARR> &raw_stream,
                        bool &isLastIndicate) {
...
void enqueue_layerStream2layer(hls::stream<INPUT_LAYER_STREAM> &src_mgs_stream, hls::stream<INPUT_LAYER_ARR> &raw_stream,
                               bool &isLastIndicate) {
...
void dequeue_layer2atom(hls::stream<dma_data_packet> &des_dma_stream, hls::stream<OUTPUT_LAYER_ARR> &raw_stream,
                        bool isLastIndicate) {
    dma_data_packet dma_tmp;
    dma_tmp.last = 0;
...
void dequeue_layer2layer(hls::stream<OUTPUT_LAYER_STREAM> &des_mgs_stream, hls::stream<OUTPUT_LAYER_ARR> &raw_stream,
                         bool isLastIndicate) {
