...
class VitisUnifiedPartial_MagicArchGen:
    ...
    def gen_vivado_project(cls, meta: VitisUnifiedWriterMeta, model, mg):
        ...
        vivado_project_src_script_path = os.path.join(
            filedir, f'../../templates/vitis_unified_partial/board_support/{board_name}/project_builder.tcl'
        )
        ...
        # copy mgs argument
        vivado_project_src_meta_arg_path = os.path.join(
            filedir, '../../templates/vitis_unified_partial/board_support/mga_meta.tcl'
        )
        des_projectscript_meta_arg_path = f'{vivado_project_des_folder_path}/mga_meta.tcl'

        fin = open(vivado_project_src_meta_arg_path)
        ...
        for line in fin.readlines():
            ...
            if "HLS_CFG_MGS_M" in line:
                ...
                for gid in range(meta.vitis_unified_config.get_amt_graph()):
                    ...
                    output_connect_names = cls.convert_idx_to_io_name(
                        meta, mg, mgs_buffer_con_idx, model, gid, False, "DUMMY"
                    )
    ...
    def write_mgs(self, meta: VitisUnifiedWriterMeta, model):
        ...
        filedir = os.path.dirname(os.path.abspath(__file__))
        fin = open(os.path.join(filedir, '../../templates/vitis_unified_partial/ips/magic_streamer_grp_src/streamGrp.v'))
        ...
        for line in fin.readlines():
            ...
            if "// hls4ml-streamGrp-gen-parameter" in line:
                ...
                ioList.append("input  wire                                               finStoreProxyDma")
