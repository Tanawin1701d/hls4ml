...
from .magic_streamer_mng import MgsModel
...
class VitisUnifiedPartialBackend(VitisUnifiedBackend):
    ...
    def build(
        ...
        if compose_streamers:
            ...
            self.run_term_command(
                ...
                "vivado -mode gui -source composer.tcl",
                log_to_stdout,
            ...
            self.run_term_command(
                ...
                "vivado -mode gui -source project_builder.tcl",
                log_to_stdout,
                magic_arch_prj,
            )
    ...
    def create_initial_config(
        ...
        gmemBuf_in_size=12,
        gmemBuf_out_size=12,
        xpfmPath='/tools/Xilinx/Vitis/2023.2/base_platforms/' 'xilinx_zcu102_base_202320_1/xilinx_zcu102_base_202320_1.xpfm',
